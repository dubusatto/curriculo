...
## Resumo Profissional
Acadêmico de Análise e Desenvolvimento de Sistemas em transição de carreira, com sólida experiência prévia em gestão de processos e equipes. Atualmente **desenvolvendo habilidades práticas em** Python, Java, programação mobile, análise de dados (Power BI, MySQL) e **fundamentos de computação em nuvem (Microsoft Azure)**. Buscando aplicar habilidades analíticas e técnicas para construir soluções de software eficientes.
